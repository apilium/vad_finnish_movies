...
MODELS = {
    'crnn': {
        'model': crnn,
        'encoder': torch.load('../pretrained_models/labelencoders/students.pth'),# students and 2
        'outputdim': 2,
    },
    'gpvb': {
        'model': crnn,
        'encoder': torch.load('../pretrained_models/labelencoders/students.pth'),
        'outputdim': 2,
    }
}
...
def main():
    ...
    parser.add_argument('-po',
                        ...
                        type=str)
    parser.add_argument('--pre', '-p', default='../pretrained_models/sre/model.pth')#change sre
